...
import com.example.isalmiapp.databinding.FragmentQuranBinding
import com.example.isalmiapp.quran.QuranContentActivity
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        adapter.OnSuraClickListner = object : CustomAdapterQuran.OnItemClickListner {
            override fun OnItemClick(pos: Int, SuraName: String) {
                var Intent = Intent(activity, QuranContentActivity::class.java)
